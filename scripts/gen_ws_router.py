with open("backend/app/routers/websocket.py", "w", encoding="utf-8") as f:
    f.write('''from fastapi import APIRouter, WebSocket, WebSocketDisconnect, Query
import json
import logging
...
''')
print("Successfully generated backend/app/routers/websocket.py")
