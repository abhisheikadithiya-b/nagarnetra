with open("backend/app/models/schema.py", "w", encoding="utf-8") as f:
...
class Device(Base):
    ...
    id = Column(String, primary_key=True)                     # dev ID, e.g. BMTC-KA-01-F-9412
    ...
    last_lat = Column(Float, default=12.9716)
    last_lon = Column(Float, default=77.5946)
...
class Bus(Base):
    ...
    id = Column(String, primary_key=True)                     # e.g. BUS-1042, BMTC-KA-01-F-9412
    ...
    pilot_name = Column(String, default="S. Kumar")
    model = Column(String, default="Volvo B9R")
    depot = Column(String, default="BMTC Depot 25")
    ...
    current_lon = Column(Float, default=77.5946)
...
class Incident(Base):
    ...
    ward = Column(String, default="Ward 04")
    zone = Column(String, default="Bengaluru North Central")
    lat = Column(Float, nullable=False)
    lon = Column(Float, nullable=False)
...
class RoadEdge(Base):
    ...
    id = Column(String, primary_key=True)                     # OSM Way ID, e.g. w482913
    name = Column(String, default="Outer Ring Road")
    corridor = Column(String, default="500-D")
    start_lat = Column(Float, default=12.9716)
    start_lon = Column(Float, default=77.5946)
    end_lat = Column(Float, default=12.9750)
    end_lon = Column(Float, default=77.6000)
...
class AuditLog(Base):
    ...
    operator_id = Column(String, default="#DESHMUKH-88")
    action = Column(String, nullable=False)
    resource_type = Column(String, nullable=False)
    resource_id = Column(String, nullable=False)
    details = Column(Text, default="")
''')
print("Successfully generated backend/app/models/schema.py")
