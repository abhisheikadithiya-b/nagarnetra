...
migration_content = '''"""0001_initial_schema
...
with open("backend/alembic/versions/0001_initial_schema.py", "w", encoding="utf-8") as f:
    f.write(migration_content)

print("Created backend/alembic/versions/0001_initial_schema.py")
